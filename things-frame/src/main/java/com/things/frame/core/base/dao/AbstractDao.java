package com.things.frame.core.base.dao;

import java.util.List;
import java.util.Map;

import com.things.frame.core.exception.DaoException;
...
import com.things.common.random.UUIDUtils;
import com.things.common.type.TypeUtils;
import com.things.frame.core.base.dao.constants.SqlId;
 ...
 */
public abstract class AbstractDao<T extends Identifiable> implements IBaseDao<T> {
	...
	public <V extends T> V selectOne(T query) {
		...
		try {
			Map<String, Object> params = TypeUtils.toMap(query);
	...
	protected Map<String, Object> getParams(T query, Pageable pageable) {
		Map<String, Object> params = TypeUtils.toMap(query, getRowBounds(pageable));
